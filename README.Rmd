...
<sup>dT</sup>&frasl;<sub>dt</sub> = r - (d - p)T,
...
T<sub>RM</sub> loss can be modeled by log-transforming this second equation to obtain a linear regression model with intercept $\log(T^0)$ and slope $-(d-p)$, i.e.
